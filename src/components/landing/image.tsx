...
import darkimage from "../../../public/light.png";
...
export const HeroImage = () => {
    ...
    return (
        ...
        <div className="relative group md:mt-14 ">
            <div className="shadow absolute top-2 lg:-top-8 left-1/2 transform -translate-x-1/2 w-[90%] mx-auto h-24 lg:h-80 bg-gradient-to-b from-blue-700/50 to-background rounded-sm blur-3xl text-blue-500"></div>
            <Image
                width={1200}
                height={1200}
